...
#set up pygame stuff
pygame.init()  
pygame.display.set_caption("YEEEEEEE")  # sets the window title
...
#images and fonts
SheepPic = pygame.image.load("sheepbang.png")
pigPic = pygame.image.load("bigcowww.png")
font = pygame.font.Font('freesansbold.ttf', 32)
text = font.render('Da Score:', True, (200, 200, 0))
text2 = font.render(str(score), True, (200, 200, 0))
text3 = font.render('DANG YOU WIN!', True, (200, 200, 0))
